...
#define Rcut_List     (18.0) // AKMA (Angstrom) 9.75 for hydrocarbons **need to adjust this parameter!!!!**
#define MaxNBond      (100)
#define MaxNeighb     (2200)
#define MaxList       (2500)
...
#define swb         (16.0)    //upper Tapper-radius
...
#define  alpha0N   3.39   // Free atom dipole polarizability a.u.
#define  alpha0C   8.79   // Free atom dipole polarizability a..u
#define  alpha0B  16.84   // Free atom dipole polarizability a.u.
#define  alpha0H   4.5   // Free atom dipole polarizability a.u.
#define  C60N     1.5*13.265  // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60B     1.5*65.17 // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60H     1.4*4.5   // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60C     1.4*30.0   // Free atom C6 coefficient in Hartree*Bohr^6
#define  VeffN    0.863   // Relative Hirshfeld volume for N in h-BN
#define  VeffB    0.778  // Relative Hirshfeld volume for B in h-BN
#define  VeffH    0.62   // Relative Hirshfeld volume for B in h-BN
#define  VeffC    0.848   // Relative Hirshfeld volume for B in h-BN
...
#define  NN_C6    (sqr(VeffN) * C60N * To_Kcal_mol_Angstrom6*1.0/eV2kcalmole) // Bulk C6 coefficient in Hartree*Bohr^6
#define  BB_C6    (sqr(VeffB) * C60B * To_Kcal_mol_Angstrom6*1.0/eV2kcalmole) // Bulk C6 coefficient in Hartree*Bohr^6
#define  HH_C6    (sqr(VeffH) * C60H * To_Kcal_mol_Angstrom6*1.0/eV2kcalmole) // Bulk C6 coefficient in Hartree*Bohr^6
#define  CC_C6    (sqr(VeffC) * C60C * To_Kcal_mol_Angstrom6*1.0/eV2kcalmole) // Bulk C6 coefficient in Hartree*Bohr^6
...
//#define  C_vdW    (0.13*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW 
// C6 coeficients in kcal/mol
...
#define  BN_BN_C_vdW    (0.18*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  C_BN_C_vdW    (0.15*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  C_C_C_vdW    (4.4*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  CB_C_vdW    (0.13*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  CN_C_vdW    (0.23*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  CC_C_vdW    (0.84*1.0/eV2kcalmole) //definins the degree of the tranlational component in vd
#define  CH_C_vdW    (0.13*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  BH_C_vdW    (0.13*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW
#define  NH_C_vdW    (0.13*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW

//#define NN_rvdW_long (3.69) //Old value
#define NN_rvdW_long (3.7)
...
#define CB_rvdW_long (2.5)
#define CN_rvdW_long (3.6)
#define CC_rvdW_long (2.7)
...
#define CC_rvdw   (2.0*1.501)  //is the 2* correct??????
#define CB_rvdw   (2.0*1.7)    //is the 2* correct??????

//long range rvdW

// Epsilons have units of Kcal/mole which are also AKMA units of energy.
#define H_Epsilon (0.0616*1.0/eV2kcalmole) //Dij in some articles
#define B_Epsilon (0.05*1.0/eV2kcalmole)   //Dij in some articlse
#define N_Epsilon (0.1375*1.0/eV2kcalmole) //Dij in some article
#define BH_Epsilon (0.0566*1.0/eV2kcalmole) //Dij in some articles
#define NH_Epsilon (0.0567*1.0/eV2kcalmole) //Dij in some articles
#define BN_Epsilon (0.0564*1.0/eV2kcalmole) //Dij in some articles

#define CH_Epsilon (0.0566*1.0/eV2kcalmole) //Dij in some articles
#define CB_Epsilon (0.0567*1.0/eV2kcalmole) //Dij in some articles
#define CN_Epsilon (0.0564*1.0/eV2kcalmole) //Dij in some articles
#define C_Epsilon (0.0564*1.0/eV2kcalmole) //Dij in some articles

// Epsilons have units of Kcal/mole which are also AKMA units of energy.
#define H_Epsilon_long (0.31*1.0/eV2kcalmole) //Dij in some articles
#define B_Epsilon_long (0.46*1.0/eV2kcalmole)   //Dij in some articlse
#define N_Epsilon_long (0.21*1.0/eV2kcalmole) //Dij in some article
#define BH_Epsilon_long (0.31*1.0/eV2kcalmole) //Dij in some articles
#define NH_Epsilon_long (0.25*1.0/eV2kcalmole) //Dij in some articles
#define BN_Epsilon_long (0.2*1.0/eV2kcalmole) //Dij in some articles

#define CH_Epsilon_long (0.31*1.0/eV2kcalmole) //Dij in some articles
#define CN_Epsilon_long (0.21*1.0/eV2kcalmole) //Dij in some articles
#define C_Epsilon_long (0.21*1.0/eV2kcalmole) //Dij in some articles
#define CB_Epsilon_long (0.37*1.0/eV2kcalmole) //Dij in some articles
...
#define CN_alpha (9.5106)
#define C_alpha (9.5106)
...
#define CN_alpha_long (12.0)
#define C_alpha_long (10.0)
...
#define BN_Tersoff_A (1380)
#define BN_Tersoff_B (340.0)
...
#define NN_Tersoff_A (128.868)
#define NN_Tersoff_B (138.778)
...
#define BB_Tersoff_A (40.520156)
#define BB_Tersoff_B (43.132016)
...
#define CC_Tersoff_A (1393.6)
#define CC_Tersoff_B (430.0)
...
#define CB_Tersoff_c (38049)
#define CB_Tersoff_d (4.3484)
#define CB_Tersoff_sqr_c (sqr(CC_Tersoff_c))
#define CB_Tersoff_sqr_d (sqr(CC_Tersoff_d))
#define CB_Tersoff_h (-0.93)
#define CB_Tersoff_n (0.72751)
#define CB_Tersoff_A (1393.6*eV2kcalmole)
#define CB_Tersoff_B (430.0*eV2kcalmole)
#define CB_Tersoff_beta (1.5724e-7)
#define CB_Tersoff_lambda1 (3.4879)
#define CB_Tersoff_lambda2 (2.2119)
#define CB_Tersoff_lambda3 (0.0)
#define CB_Tersoff_D (0.15)
#define CB_Tersoff_R (1.95)

#define CN_Tersoff_c (38049)
#define CN_Tersoff_d (4.3484)
#define CN_Tersoff_sqr_c (sqr(CC_Tersoff_c))
#define CN_Tersoff_sqr_d (sqr(CC_Tersoff_d))
#define CN_Tersoff_h (-0.93)
#define CN_Tersoff_n (0.72751)
#define CN_Tersoff_A (1393.6*eV2kcalmole)
#define CN_Tersoff_B (430.0*eV2kcalmole)
#define CN_Tersoff_beta (1.5724e-7)
#define CN_Tersoff_lambda1 (3.4879)
#define CN_Tersoff_lambda2 (2.2119)
#define CN_Tersoff_lambda3 (0.0)
#define CN_Tersoff_D (0.15)
#define CN_Tersoff_R (1.95)
// *********************** structures  **********************
...
typedef struct
{
  ...
  double Tersoff_R,Tersoff_D,Tersoff_sqr_d,Tersoff_sqr_c,C_vdW;
} BondParamsStruct;
typedef struct
{
...
void Print_Traj(FILE *TrajFile, int Natoms, double t, atom *particle,double Xmin,double Ymin,double Zmin,double Xmax,double Ymax,double Zmax,point L);
...
void calc_F_KC(point *FvdW, int Natoms, atom *particle, double *rijShiled_1, BondParamsStruct *BondParams, point L,Normal_struct *Normal,int *Normal_atom,int Interlayer,int *Neighb,int *NNeighb,dr_ij *dN,double &ERep);
...
double calc_F_Rep_pot(int Natoms, atom *particle, double *rijShiled_1, BondParamsStruct *BondParams, point L,Normal_struct *Normal,int *Normal_atom,int Interlayer,int *Neighb,int *NNeighb,dr_ij *dN,double &ERep);
