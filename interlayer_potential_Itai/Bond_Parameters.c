...
void Init_Bond_Params(BondParamsStruct *BondParams)
{
  ...
  BondParams[index1].Tersoff_D       = BB_Tersoff_D;
  BondParams[index1].C_vdW           = BN_BN_C_vdW;      
  //C-C
  
  index1 = 6*NAtomParams + 6;

  BondParams[index1].lambdaW  = C_lambdaW;
  BondParams[index1].alpha    = C_alpha;
  BondParams[index1].rvdw     = CC_rvdw;
  BondParams[index1].Epsilon  = C_Epsilon;
  ...
  BondParams[index1].rcore    = C_rcore;
  BondParams[index1].ecore    = C_ecore;
  BondParams[index1].acore    = C_acore;
  ...
  BondParams[index1].Tersoff_D       = CC_Tersoff_D;
  BondParams[index1].C_vdW           = C_C_C_vdW;      
  ...
  BondParams[index1].Tersoff_D       =  BondParams[index2].Tersoff_D       = BN_Tersoff_D;
  BondParams[index1].C_vdW           =  BondParams[index2].C_vdW           = BN_BN_C_vdW;      
  ...
  BondParams[index1].lambdaW  = BondParams[index2].lambdaW  = sqrt(C_lambdaW*N_lambdaW);
  BondParams[index1].alpha    = BondParams[index2].alpha    = CN_alpha;
  BondParams[index1].rvdw     = BondParams[index2].rvdw     = CN_rvdw;
  BondParams[index1].Epsilon  = BondParams[index2].Epsilon  = CN_Epsilon;
  ...
  BondParams[index1].rcore    = BondParams[index2].rcore    = sqrt(C_rcore*N_rcore);
  BondParams[index1].ecore    = BondParams[index2].ecore    = sqrt(C_ecore*N_ecore);
  BondParams[index1].acore    = BondParams[index2].acore    = sqrt(C_acore*N_acore);
  ...
  BondParams[index1].Tersoff_D       =  BondParams[index2].Tersoff_D       = CN_Tersoff_D;
  BondParams[index1].C_vdW           =  BondParams[index2].C_vdW           = C_BN_C_vdW;
  //C-N
  ...
  BondParams[index1].lambdaW  = BondParams[index2].lambdaW  = sqrt(C_lambdaW*B_lambdaW);
  BondParams[index1].alpha    = BondParams[index2].alpha    = CB_alpha;
  BondParams[index1].rvdw     = BondParams[index2].rvdw     = CB_rvdw;
  BondParams[index1].Epsilon  = BondParams[index2].Epsilon  = CB_Epsilon;
  ...
  BondParams[index1].rcore    = BondParams[index2].rcore    = sqrt(C_rcore*B_rcore);
  BondParams[index1].ecore    = BondParams[index2].ecore    = sqrt(C_ecore*B_ecore);
  BondParams[index1].acore    = BondParams[index2].acore    = sqrt(C_acore*B_acore);
  ...
  BondParams[index1].lambdaW  = BondParams[index2].lambdaW  = sqrt(C_lambdaW*H_lambdaW);
  BondParams[index1].alpha    = BondParams[index2].alpha    = CH_alpha;
  BondParams[index1].rvdw     = BondParams[index2].rvdw     = CH_rvdw;
  BondParams[index1].Epsilon  = BondParams[index2].Epsilon  = CH_Epsilon;
  ...
  BondParams[index1].rcore    = BondParams[index2].rcore    = sqrt(C_rcore*H_rcore);
  BondParams[index1].ecore    = BondParams[index2].ecore    = sqrt(C_ecore*H_ecore);
  BondParams[index1].acore    = BondParams[index2].acore    = sqrt(C_acore*H_acore);
  ...
  BondParams[index1].C_vdW           =  BondParams[index2].C_vdW           = C_C_C_vdW;
