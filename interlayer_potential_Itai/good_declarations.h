...
#define Rcut_List     (22.0) // AKMA (Angstrom) 9.75 for hydrocarbons **need to adjust this parameter!!!!**
#define MaxNBond      (100)
...
#define swb         (20.0)    //upper Tapper-radius
...
#define  alpha0N   3.707   // Free atom dipole polarizability a.u.
#define  alpha0C   9.260   // Free atom dipole polarizability a..u
#define  alpha0B  17.485   // Free atom dipole polarizability a.u.
#define  alpha0H   4.5   // Free atom dipole polarizability a.u.
#define  C60N     20.051  // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60B     100.416 // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60H     5.0   // Free atom C6 coefficient in Hartree*Bohr^6
#define  C60C     47.16   // Free atom C6 coefficient in Hartree*Bohr^6
#define  VeffN    0.866   // Relative Hirshfeld volume for N in h-BN
#define  VeffB    0.781  // Relative Hirshfeld volume for B in h-BN
#define  VeffH    0.62   // Relative Hirshfeld volume for B in h-BN
#define  VeffC    0.852   // Relative Hirshfeld volume for B in h-BN
...
#define  C_vdW    (0.068*1.0/eV2kcalmole) //definins the degree of the tranlational component in vdW 
// C6 coeficients in kcal/mol
...
#define CB_Epsilon_long (0.2*1.0/eV2kcalmole) //Dij in some articles
...
#define CN_alpha_long (13.5)
#define CB_alpha_long (9.7)
